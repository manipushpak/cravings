...
const GoogleMapElement = withGoogleMap(props => (
   ...
   >
   {
      props.vendors.map(vendor => {
         ...
         let coordinates = {lat:34.0224, lng:-113.2851};

         // geocoder.geocode({'address': vendorInfo.address}, function(results, status, coordinates) {
      ...
      return(
         <div>
            <GoogleMapElement
               ...
               mapElement={<div style={{ height: '1024px'}} />}
